...
\usepackage[colorlinks=true,linkcolor=LFRgreen]{hyperref}
...
% Define Hyperlinks:
\hypersetup{pdfborder={0 0 0}, colorlinks=true, urlcolor=LFRgreen}
\hypersetup{%
   citecolor=LFRgreen
}
...
\includegraphics[width=\textwidth]{images/lfr_5e.png}
